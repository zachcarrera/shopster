        ...
        <div>
            ...
            <form className='form max-w-md mx-auto' onSubmit={handleSubmit}>
                <div className='mb-4'>
                    ...
                    <input type="text" name="name" value={name} className='border rounded w-full py-2 px-3'
                        onChange={event => setName(event.target.value)} />
                </div>
                <div className='mb-4'>
                    <label className='block font-bold'>Description:</label>
                    <input type="text" name="description" value={description} className='border rounded w-full py-2 px-3'
                        onChange={event => setDescription(event.target.value)} />
                </div>
                <div className='mb-4'>
                    <label className='block font-bold'>Image URL:</label>
                    <input type="text" name="image" value={image} className='border rounded w-full py-2 px-3'
                        onChange={event => setImage(event.target.value)} />
                </div>
                <div className='mb-4'>
                    <label className='block font-bold'>Price:</label>
                    <input type="number" name="price" value={price} className='border rounded w-full py-2 px-3'
                ...
                <Link className='bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded' to='/'>Cancel</Link>
                {

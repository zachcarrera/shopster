...
export const Navbar = () => {
    ...
    return (
        <nav className="border-b p-4 border-gray-500 flex justify-center gap-12">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" style={{transform: "scale(1.5)", fill: "green", stroke: "blue"}} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
